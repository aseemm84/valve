...
- Low FL (0.50–0.65): good pressure recovery; the vena contracta pressure is much lower than the outlet pressure. Cavitation can occur at moderate $\Delta P$. Because $P_2$ recovers to a level relatively close to $P_1$, the overall pressure drop ($P_1 - P_2$) is small compared to the deep pressure drop at the vena contracta ($P_1 - P_{vc}$). This ratio results in a low $F_L$. Streamlined valves like ball and butterfly valves fall into this category.
